...
"""
# python val.py --weights E:\PythonProject\target_detection\IA_YOLO\runs\train\exp\weights\best.pt
import argparse
import json
import os
import subprocess
...
def parse_opt():
    ...
    parser.add_argument("--data", type=str, default=r"E:\PythonProject\target_detection\data\RTTS_split\data.yaml", help="dataset.yaml path")
    parser.add_argument("--weights", nargs="+", type=str, default=r"E:\PythonProject\target_detection\IA_YOLO\runs\train\exp3\weights\best.pt", help="model path(s)")
