...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default=r"E:\PythonProject\target_detection\IA_YOLO\models\iayolov5n.yaml", help="model.yaml path")
    ...
    parser.add_argument("--hyp", type=str, default=ROOT / "data/hyps/hyp.ia-yolo.yaml", help="hyperparameters path")
