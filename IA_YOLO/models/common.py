...
from IA_YOLO.utils import TryExcept
from IA_YOLO.utils.dataloaders import exif_transpose, letterbox
from IA_YOLO.utils.general import (
    LOGGER,
    ROOT,
    Profile,
    check_requirements,
...
from IA_YOLO.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights="yolov5s.pt", device=torch.device("cpu"), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from IA_YOLO.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
